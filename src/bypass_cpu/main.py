"""Bypass RV32I CPU with memory support and precise in-order control flow."""
...
from ..naive_cpu.modules.fetch import Fetcher
...
def build_cpu(
    ...
    *,
    ...
    """Build and elaborate the Bypass memory-capable RV32I CPU."""
    ...
    with sys:
        ...
        dcache.name = "bypass_memory_dcache"
