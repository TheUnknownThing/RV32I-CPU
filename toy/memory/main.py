"""A toy RV32I CPU with full RV32I memory support and a 5-stage pipeline."""
...
def run_memory_cpu(
    ...
    **kwargs,
    ...
    """Builds the memory-capable CPU and runs its simulator."""
...
if __name__ == "__main__":
    ...
    print("Toy Memory CPU built successfully!")
