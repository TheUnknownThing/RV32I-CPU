"""A toy RV32I CPU with memory support and precise in-order branch handling."""
...
def build_cpu(
    ...
    *,
    ...
    """Build and elaborate the toy memory-capable RV32I CPU."""
    ...
    with sys:
        ...
        dcache = SRAM(width=32, depth=data_word_depth, init_file=str(data_image))
...
def run_branch_cpu(
    ...
    **kwargs,
    ...
    """Builds the branch-capable CPU and runs its simulator."""
...
if __name__ == "__main__":
    ...
    print("Toy Branch CPU built successfully!")
